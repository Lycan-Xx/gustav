...
// icon imports
import yedc from '../assets/logo.jpg';
import phcn from '../assets/logo.jpg';
import kedco from '../assets/logo.jpg';
import aedc from '../assets/logo.jpg';

// banner imports
import yedcBanner from '../assets/logo.jpg';
import phcnBanner from '../assets/logo.jpg';
import kedcoBanner from '../assets/logo.jpg';
import aedcBanner from '../assets/logo.jpg';
...
const services = [
  ...
  {
    title: 'PHCN',
    description: 'Power Holding Company of Nigeria',
    icon: phcn,
    image: phcnBanner,
  },
  {
            ...
            {isDialogOpen && (
              <div className="fixed bottom-20 right-6 bg-white shadow-lg rounded-lg p-4 w-64">
                ...
                <div className="flex flex-col space-y-2">
                  <button
                    onClick={() =>
                      (window.location.href = 'mailto:contact@school.com')
                    }
