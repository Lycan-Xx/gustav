...
const services = [
  { title: '9 mobile', description: '9 mobile', icon: logo, image: logo },
  { title: 'Airtel', description: 'Airtel', icon: logo, image: logo },
  { title: 'Glo', description: 'Glo', icon: logo, image: logo },
  { title: 'M T N', description: 'M T N', icon: logo, image: logo },
];
...
const Databundles = ({ onBack }) => {
  ...
  const handleBackClick = () => {
    if (selectedService) {
      if (
        window.confirm(
          'Are you sure you want to go back? Unsaved progress will be lost.'
        )
      ) {
